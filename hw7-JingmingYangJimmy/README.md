...
However, your prototype **must** be _interactive_, e.g. the user should be able to navigate by pressing on the screen, **not** by pressing arrows on the keyboard.
...
https://www.figma.com/file/dv6n2ty6daFouUHLoZGx7C/hw7-cs571?type=design&node-id=0%3A1&mode=design&t=bKudqTiiiZo9OOre-1

## Badger Bakery Implementation

The starter code provided to you was generated using [expo](https://expo.dev/), therefore the "boilerplate" code has already been generated. **You should _not_ re-run the expo init command**. Instead, in this directory, simply run...
...
Note that this endpoint returns an _object_ and not a _list_ -- you may find `Object.keys` helpful here.
...
- You may **NOT** hardcode the data of any items, such as their name. e.g. hardcoding "cupcake", "donut", "pie", or "cake" is prohibited! Being a busy bakery in Madison, the items we sell may vary from day-to-day, and we should _not_ assume we will always be selling these same items.
