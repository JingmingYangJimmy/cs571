...
function calculateSubtotal() {
    ...
    let quantity = parseInt(document.getElementById(itemName+"-quantity").value);
    let price = parseFloat(document.getElementById(itemName+"-price").innerText);
...
function calculateSalesTax() {
	...
	return roundMoney(calculateSubtotal() * getSalesTaxRateForState(state));
...
document.getElementById("btn-checkout").addEventListener("click", () => {
	let total=calculateSalesTax()+calculateSubtotal();
